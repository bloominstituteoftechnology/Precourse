...
created.innerHTML = ('This app was created by: Neal');
...
function addTodo() {
  ...
  */
  ...
  let add = new Todo(newTodo.value);
  toDoItems.push(add);
  newTodo.innerHTML = '';
  displayTodos();
}
