...
created.innerHTML = "This app was created by: Justin Kaseman";
...
function buildTodos(todoArray) {
  let newArray = todoArray.map(buildTodo);
  return newArray;
  /*
...
function displayTodos() {
  ...
  for (let i = 0; i < builtTodos.length; i++){
    display.appendChild(builtTodos[i]);
  }
  /*
...
function addTodo() {
  ...
  */
  ...
  let newObject = new Todo(newTodo);
