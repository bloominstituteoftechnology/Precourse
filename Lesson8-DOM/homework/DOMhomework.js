...
function buildTodo(object, index) {
  ...
  // todoText = todoText.addEventListener('click', function(completeTodo) {
  ...
  // todoText.innerHTML = object.description;
    ...
    // todoText.querySelector('#todoInput').addEventListener('click', completeTodo);
...
function buildTodos(arr) {
  ...
  let mapArray = arr.map(buildTodo); 
...
function displayTodos() {
  ...
  */
   ...
   function buildTodos(toDoItems) { 
    ...
    todoContainer.appendChild(toDoItems[item]);
  };
...
// let newTodo = new Todo(document.querySelector('#todoInput').value);
