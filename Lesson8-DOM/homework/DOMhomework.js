...
createdBy.innerHTML += " Juber Ahmed";
...
/* STEP 3: Add a completeTodo method to the prototype of Todo. It will not take any arguemnts. 
Inside the function set the Todo's complete to true*/
...
/*
  STEP 5: This function, buildTodo, will take an 
...
/*6.)Using an if statement, check to see if the 'complete' value on the object passed as the first argument is true. 
If it is, give todoText a class of 'completeText'. If it is not, do not giveit a class.*/
...
/* 5.) at the very end of this file, the line before the comment 
"DO NOT CHANGE ANY CODE BELOW THIS LINE", call this function. */
/*done*/
}
...
function addTodo() {
 /* STEP 8: This function, 'addTodo' will add a new Todo to the array of todos.
  ...
  so we will give you a little more code to go on here. 'newTodo' is an text input element.
  All text input elements have a property called 'value', 
...
// 1.) Using the value property on newTodo, create an new Todo object and pass the value as the description.
  let oldTodo = new Todo (newTodo.value);
  
// 2.) add the object from (1) into the toDoItems array.
  toDoItems.push(oldTodo);
...
function completeTodo(event) {
  /* 
STEP 10: Finally in this step we will define the function to run when we want to compelte a todo, 
