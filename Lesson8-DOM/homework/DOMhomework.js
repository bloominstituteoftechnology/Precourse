...
created.innerHTML = `${created.innerHTML} Clint Tarrant`;
...
function buildTodos(todoArr) {
  ...
  */
  let newArr = return todoArr.map(buildTodo);
  return newArr;
}
...
function displayTodos() {
  ...
  */
  ...
  let todoBox = document.querySelector('#todoContainer');
  todoContainer.innerHTML = '';

  return buildTodos(toDoItems);
...
function addTodo() {
  ...
  */
  ...
  //UNCOMMENT THE NEXT LINE
   ...
   let newTodoObject = new Todo(newTodo.value);
