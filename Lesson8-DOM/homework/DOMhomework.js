...
created.innerHTML = created.innerHTML + " Jen";
// ref: https://www.w3schools.com/jsref/met_document_queryselector.asp
...
let todoAdd = new Todo(newTodo.value);
toDoItems.push(todoAdd);
newTodo.value = ""; 
displayTodos();
}
...
STEP 8: This function, 'addTodo' will add a new Todo to the array of todos.
  ...
  'newTodo' is an text input element. All text input elements have a property called 'value', this value will be whatever is typed into the text box on the page.
