...
created.innerHTML+=' Seddik Ouaaz';
...
if (Todo.complete==true){
  ...
  */
  ...
  function buildTodos(arrofTodo) {
    ...
    */
    let mapArray=arrofTodo.map(buildTodo);
    return mapArray;
  }
  ...
  function addTodo() {
    ...
    */
    ...
    let newTodobj=new Todo(newTodo.value);
    toDoItems.push(newTodobj);
    newTodo.value='';
    newTodo.focus();
    displayTodos();
  }
