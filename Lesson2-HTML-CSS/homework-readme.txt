This is the instructions for the homework for Lambda School's pre-course, Lesson 2 - HTML/CSS fundamentals.
...
II. Add some style
  ...
  B. Give your third div the id "divId".
...
III. Create an external style sheet and import all of our previous style rules into the new stylesheet.
  A. Create a styles.css file in this folder.
  B. COPY all of your style rules to this new file. 
  C. Place: <!-- in from of your first style tag.
...
Extra credit:   
  ...
  do some further homework, I recoomend the additional resources or https://www.w3schools.com/css/default.asp)
