...
function forEach(arr, cb) {
  ...
  let test = arr.forEach(function(item, index){
    cb(item);
  });
  return test;
}
...
function cacheFunction(cb) {
  ...
  // if the function you return is invoked again with 5 it will look in an object in the closure scope
  // and return 25 directly and will not invoke cb again
//   let cache = {};
//   if (!(cache[arguments] in cache)) {
//     getSquare(arguments);
//     } else {
