...
function map(arr, cb) {
  ...
  // the new array should be the same length as the array 
  //argument
  let arr1 = arr.map(cb);
  return arr1;
}
...
function createUserClass() {
  ...
  // it should accept an options object with username, name, 
  //email, and password properties
  // in the constructor set the username, name, email, and
  // password properties
  // the constructor should have a method 'sayHi' on its
  // prototype that returns the string 
...
function addPrototypeMethod(Constructor) {
  ...
  // the method should be called 'sayHi' and should
