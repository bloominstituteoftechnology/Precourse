...
function addProperty(object, property) {
  // add the property (key) to the object with a value of null
  // return the object
  // note: the property (key) name is NOT 'property'.  The name is the value of the argument called property (a string)
...
function sumUserPostLikes(user) {
  ...
  for (let i = 0; i < user.length; i++) {
    const myObject = myObject.property[i];
    sum+=myObject.likes;
  }
  return sum;
}
