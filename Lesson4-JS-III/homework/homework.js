...
function multiplyMysteryNumberByFive(mysteryNumberObject) {
  ...
  let prod = mysteryNumberObject['mysteryNumber']*5;
  return prod;
}
...
function sumUserPostLikes(user) {
  ...
  // return the sum
  let j = 0;
  let postslength = user['posts'].length;
  for (let i = 0; i , i < postslength; i++){
    let postobject = user.posts[i];
    let postlikes = postobject.likes;
    j = j+ postlikes;
  }
  return j;
}
