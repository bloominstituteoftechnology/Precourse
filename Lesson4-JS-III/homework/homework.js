...
function hasEmail(user) {
  ...
  if (Object.prototype.hasOwnProperty.call(user, 'email') && Boolean(user['email'])) {
    return true;
  } else {
    return false;
  }
...
function sumUserPostLikes(user) {
  ...
  // return the sum
  var likeSum = 0;
  var countVariable = user.posts;

  for (var i = 0; i < countVariable.length; i++) {
    likeSum = likeSum + countVariable[i].likes;
  }
