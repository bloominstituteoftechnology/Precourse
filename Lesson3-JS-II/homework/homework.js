...
//console.log("The number is prime:", isPrime(13))
...
function wordsToSentence(words) {
  ...
  let str = words[0];
  //console.log("This is str before loop: ", str+'.')
  //console.log("This is str length", str.length)
  for (let i=1; i<words.length; i++) {
    
    //console.log("This is i: ", i,'; This is words[i]: ', words[i] );
    str+=' '+words[i];
    //console.log('This is i:', i, 'THis is str:', str+'.')
...
//words = ['a','b','c','d','e','f','g']
//console.log('The array contains the item: ',contains([], true))
//[97, 100, 80, 55, 72, 94], 'Hello')
//[], true
