...
// code here
document.querySelector('#createdBy').innerHTML += ' Lukasz Busk';
...
// code here
ToDo.prototype.completeToDo = function completeToDo() { this.complete = true };
/*
...
function displayToDos() {
  ...
  buildToDos(toDoItems).forEach(element => toDoContainer.appendChild(element));
}
