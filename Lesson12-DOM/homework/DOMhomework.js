...
span.innerHTML = span.innerHTML + "Samar";
...
function buildToDo(todo, index) {
  ...
  var toDoShell = document.createElement('toDoShell');
  toDoShell.className = 'toDoShell';
  var toDoText = document.createElement('span');
  toDoText.innerHTML = todo.description;
  toDoText.id = index;
  if (todo.compelte === true) {
...
function displayToDos() {
  ...
  var ar = buildToDos(toDoItems);
  ar.forEach(function (xo) {
    toDoContainer.appendChild(xo);
  })
}
