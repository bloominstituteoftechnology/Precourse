...
// code here
let creatorName = 'Ja Navey';
const writtenBy = 'This app was created by ' + creatorName;
const span = document.querySelector('#createdBy');
span.innerHTML = writtenBy;
...
function addToDo() {
  // code here
  const newToDoObject = new ToDo(document.querySelector('#toDoInput').value);
