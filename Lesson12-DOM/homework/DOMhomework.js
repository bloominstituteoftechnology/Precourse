...
// code here
const createdBy = document.getElementById('createdBy').innerHTML;
document.getElementById('createdBy').innerHTML = createdBy + "Scuba Steve";
...
function buildToDo(todo, index) {
  ...
  toDoCheck.addEventListener('click', function() { completeToDo(event) });
  toDoCheck.setAttribute('class', 'completeCheckbox');
...
function buildToDos(toDos) {
  // code here
  toDoElements = toDos.map(buildToDo);
  return toDoElements;
}
