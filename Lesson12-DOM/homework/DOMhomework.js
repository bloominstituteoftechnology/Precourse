...
// code here
const spanBy = document.querySelector('#createdBy');
const oldHTML = spanBy.innerHTML;
const newHTML = ' Eva Adams';
spanBy.innerHTML = oldHTML + newHTML;
...
function buildToDos(toDos) {
  // code here
  const mappedArray = toDos.map(buildToDo);
  return mappedArray;
}
...
function displayToDos() {
  ...
  const toDosArray = buildToDos(toDoItems);
