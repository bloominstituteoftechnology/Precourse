...
/* 
  STEP 5: 
This function will build and return an array of toDo elements. It will take an array of objects of the ToDo class as it's only argument.
...
/* 
  STEP 6: 
Now that we can build an array of toDo elements, we want to make these elements appear on the screen, 
...
function displayToDos() {
  ...
  var myArray = buildToDos(toDoItems);
  for(let i = 0; i < myArray.length; i++) {
     toDoContainer.append(myArray[i]);
  }
}
...
/* 
  STEP 7: 
This function, 'addToDo' will add a new ToDo to the 'toDoItems' array.
...
/* STEP 8: 
In this step we will fire addToDo everytime the 'ADD' button is clicked.
...
/* 
  STEP 9: 
Finally in this step we will define the function to run when we want to compelte a toDo, and add that function to the click event
