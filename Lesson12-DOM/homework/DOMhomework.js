...
let addName = document.querySelector('#createdBy');
let spanText = addName.innerHTML;
addName.innerHTML = spanText + ' Ryan';
...
function addToDo() {
  ...
  let newObj = new ToDo(newToDo.value);
