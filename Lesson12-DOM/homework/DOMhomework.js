...
const spanEle = document.querySelector('#createdBy');
spanEle.innerHTML = 'This app was created by: Jacob.';
...
function addToDo() {
  ...
  const newToDoItem = new ToDo(newToDo.value);
...
const addButtonSelect = document.querySelector('#addButton');
addButtonSelect.addEventListener('click', addToDo());
...
function completeToDo(event) {
  ...
  // code here
  const newToDo = new ToDo(toDoItems[index]);
