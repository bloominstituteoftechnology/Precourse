...
*/
document.querySelector('#createdBy').innerHTML += " Andrew Koutsoftas";
// code here
...
function displayToDos() {
  ...
  var arrayOfToDos = buildToDos(toDoItems);
  for (let i = 0; i < arrayOfToDos.length; i++){
      toDoContainer.appendChild(arrayOfToDos[i]);
  }
}
...
function addToDo() {
  // code here
  let newObject = new ToDo(document.querySelector('#toDoInput').value);
