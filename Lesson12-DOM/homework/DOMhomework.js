...
const byGo = document.getElementById('createdBy');
byGo.append(' Govi Escudero');

// document.querySelector("#createdBy").append(" Govi Escudero");
...
function buildToDos(toDos) {
  // code here
  const mappedArr = toDos.map(buildToDo);
  return mappedArr;
}
...
function addToDo() {
  // code here
  // newToDo.value = new ToDo (value);
  // toDoItems.push(newToDo);
  // newToDo.value = '';
  // displayToDos();

  const doneDid = new ToDo(document.querySelector('#toDoInput').value);
  toDoItems.push(doneDid);
...
function completeToDo(event) {
  ...
  // Event is an object. Target is property within Event that also happens to be an object. Id is a property within the Target object. -- I think??
  // code here
