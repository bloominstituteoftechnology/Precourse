...
// code here
 const newQuery = document.querySelector('#createdBy')
 newQuery.innerHTML = newQuery.innerHTML + 'Rachel DiCesare'
...
function addToDo() {
  // code here
  const newToDoObj = new ToDo(document.querySelector('#toDoInput').value);
