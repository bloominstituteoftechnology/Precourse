...
*/
// code here
const newSpan = document.querySelector('#createdBy').innerHTML;
document.querySelector('#createdBy').innerHTML = newSpan.concat(' Tsai Huang');
...
function displayToDos() {
  ...
  const toDoItemsArray = buildToDos(toDoItems);
...
function completeToDo(event) {
  ...
  displayToDos();
  buildToDo.addEventListener('click',completeToDo);
}
