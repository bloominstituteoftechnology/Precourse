...
// code here
document.querySelector('#createdBy').innerHTML += ' Christopher Ferrell';
...
function buildToDo(todo, index) {
  // code here - creates div & span based upon a toDo object
...
function buildToDos(toDos) {
  // code here  - returns array of div elements that contain spans - per buildToDo method
...
function displayToDos() {
  ...
  toDoElementsArray = buildToDos(toDoItems);
  Array.from(toDoElementsArray).forEach(function(item){
...
function addToDo() {
  ...
  let description = newToDo.value;
  let newItem = new ToDo(description);
