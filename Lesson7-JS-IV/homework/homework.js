...
function newUser(name, email, password) {
  ...
  const objUser = {name: name, email: email, password: password, };
...
function hasProperty(object, property) {
  ...
  let thereisProperty = false;
  for(let varkey in object)
  { 
    if( varkey === property) { thereisProperty = true; }
  }
  return thereisProperty;
...
function sumUserPostLikes(user) {
  ...
  { 
    likes_sum = likes_sum + user.posts[i].likes;
  }
