...
function returnString(str) { returnString (str) ;
  //simply return the string provided: str
}

function add(x, y) { add (x + y) ;
  // x and y are numbers
  // add x and y together and return the value
  // code here
}

function subtract(x, y) { subtract (x,y) ;
  // subtract y from x and return the value
  // code here
}

function multiply(x, y) { multiply (x,y) ;
...
function areEqual(x, y) { areEqual (x,y) ;
  // return true if x and y are the same
  // otherwise return false
  // code here
}

function areSameLength(str1, str2) {areSameLength (str1, str2) ;
