1) A prototype is a way of setting a method once and giving every object of that class access to the method. Making things simpler and not having to create thousands of class objects.
